...
#python $ROOTPATH/src/preprocess/process_conll2012.py --trial 1 --subword --lowcase $TRAIN $ROOTPATH/data/train
#python $ROOTPATH/src/preprocess/process_conll2012.py --trial 1 --subword --lowcase $DEV $ROOTPATH/data/dev
#python $ROOTPATH/src/preprocess/process_conll2012.py --trial 1 --subword --lowcase --test $TEST $ROOTPATH/data/test
